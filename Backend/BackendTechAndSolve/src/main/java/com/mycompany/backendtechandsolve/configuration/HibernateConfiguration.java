...
@ComponentScan({"com.mycompany.backendtechandsolve.configuration"})
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() throws NamingException {
        ...
        //sessionFactory.setPackagesToScan(new String[]{"com.asopagos.zenith_be.model"});
    ...
    public DataSource dataSource() throws NamingException {
        ...
        return dsLookup.getDataSource("jdbc/techAndSolve");
    }
